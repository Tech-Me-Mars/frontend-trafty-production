        ...
        <div class="p-3 pt-8 max-w-md mx-auto">
          <section class="card">
            ...
            <div class="field">
              ...
              <InputText
                v-model="form.business_name[lang.code]"
                class="w-full input-underline"
            ...
            <div class="field">
              ...
              <InputText
                v-model="form.business_person[lang.code]"
                class="w-full input-underline"
            ...
            <div class="field">
              ...
              <InputText
                v-model="form.business_address[lang.code]"
                class="w-full input-underline"
            ...
            <div class="field">
              ...
              <InputText
                v-model="form.province[lang.code]"
                class="w-full input-underline"
            ...
            <div class="field">
              ...
              <InputText
                v-model="form.zipcode[lang.code]"
                class="w-full input-underline"
            ...
            <!-- อัปโหลดไฟล์ -->
            <div class="mt-2">
              <label class="label">{{ t('เอกสารรับรองของหน่วยงาน') }}</label>
              <FileUpload
                mode="basic"
                customUpload
                auto
              ...
              <ul v-if="form.files.length" class="mt-3 space-y-2">
                ...
                >
                  <div class="flex items-center gap-3">
                    <img
                      v-if="f.file?.type?.startsWith('image/')"
                      :src="f.src"
          ...
          <div class="mt-6 pb-10">
            <Button
              ...
              severity="primary"
              rounded
              :pt="{ root: { class: '!h-12 !rounded-full !text-base' } }"
              @click="goNext"
            />
          </div>
        </div>
...
:deep(.input-underline.p-inputtext) {
  border: 0 !important;
  border-bottom: 1px solid rgb(228 228 231) !important; /* zinc-200 */
