<template>
    <div class="chat-room">
        ...
        <LayoutsBaseHeader title="เจ้าหน้าที่ Smart Travel Safety" :showBack="true" :showMenu="false">
...
// Chat info
const chatInfo = ref({
  name: 'ภูเขา น้ำตก ถ้ำ(8)',
  subtitle: 'วันนี้',
  avatar:
    '/image/touristpolice.png', // ใช้เป็น avatar ของ "เจ้าหน้าที่"
  isGroup: true
})
// Messages mock data
const messages = ref([
  {
    id: 1,
    text:
      'เนื่องจากวันที่ 12 มกราคม 2568 จะมีการปรับปรุงพื้นที่ ในเวลา 13.30 น. กรุณาปิดธุรกิจในแหล่งท่องเที่ยวในเวลาที่กำหนด',
    time: '09:41',
    isOwn: false, // ฝั่งซ้าย
    sender: 'เจ้าหน้าที่',
    avatar: chatInfo.value.avatar
  },
  {
    id: 2,
    text: 'ได้ค่ะ รับทราบค่ะ',
    time: '09:42',
    isOwn: false, // ฝั่งซ้าย
    sender: 'เขตรังสรรค์',
    avatar:
      'https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?w=80&h=80&fit=crop&crop=faces'
  },
  {
    id: 3,
    text: 'ได้ค่ะ จะดำเนินการให้ค่ะ',
    time: '09:42',
    isOwn: false, // ฝั่งซ้าย
    sender: 'สำนักงานอาชด',
    avatar:
      'https://images.unsplash.com/photo-1491553895911-0055eca6402d?w=80&h=80&fit=crop&crop=faces'
  },
  {
    id: 4,
    text: 'รับทราบค่ะ',
    time: '09:43',
    isOwn: true, // ฝั่งขวา (เรา)
    status: 'delivered',
    sender: 'คุณ'
  }
])
