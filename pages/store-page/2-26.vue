...
// Chat info
const chatInfo = ref({
  name: 'เจ้าหน้าที่ Smart Travel Safety',
  subtitle: 'วันนี้',
  avatar: '/image/touristpolice.png',
  isGroup: true
})
...
const messages = ref([
  {
    id: 1,
    text:
      'เนื่องจากแหล่งท่องเที่ยวของคุณไม่ผ่านเกณฑ์ประเมินของกองบัญชาการตำรวจท่องเที่ยว กรุณาปรับปรุงและทางเจ้าหน้าที่จะเข้าไปตรวจสอบอีกครั้งในภายหลัง',
    time: '09:41',
    isOwn: false,                       // ฝั่งซ้าย (เจ้าหน้าที่)
    sender: 'เจ้าหน้าที่ Smart Travel Safety',
    avatar: chatInfo.value.avatar
  },
  {
    id: 2,
    text: 'ครับ ปรับปรุงให้ครับ',
    time: '09:42',
